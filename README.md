...
bok-da 리포지터리의 `docs`와 `examples` 폴더를 참고하거나, 해당 폴더의 압축파일을 다운로드한 후, 작업 디렉토리에 해제하여 활용<a href="https://bidas-s3.boknet.intra/newtech/public/bok_lib/bok-da-docs-examples-v0.3.1.7z" download>[📁예제파일 다운로드]</a>

`examples/notebooks` 폴더에 분석기능별 활용예제를 수록하였음  
