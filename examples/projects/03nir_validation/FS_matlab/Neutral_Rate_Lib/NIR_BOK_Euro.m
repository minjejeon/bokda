...
[G, ghat] = hpfilterK(Ym(:, 1), 1600);

[P, phat] = hpfilterK(Ym(:, 2), 1600);

[C, chat] = hpfilterK(Ym(:, 3), 1600);

[Z, ihat] = hpfilterK(Ym(:, 4) - P - G, 1600);
...
for iter = 1:n
    ...
    %% 추세와 순환 샘플링
    [Um, Uttm] = Gen_Um_mex(Ym, Um0, rho, Phi, Sigma, Omega); 
