              ...
              ::coder::array<real_T, 2U> &C)
{
  ...
  if ((A.size(0) == 0) || (A.size(1) == 0) || (B.size(0) == 0) ||
      (B.size(1) == 0)) {
    int32_T loop_ub;
    C.set_size(&y_emlrtRTEI, sp, A.size(0), B.size(0));
    ...
    C.set_size(&x_emlrtRTEI, &b_st, A.size(0), B.size(0));
              ...
              ::coder::array<real_T, 1U> &C)
{
  ...
  if ((A.size(0) == 0) || (A.size(1) == 0) || (B.size(0) == 0)) {
    int32_T loop_ub;
    C.set_size(&y_emlrtRTEI, sp, A.size(1));
    loop_ub = A.size(1);
    for (int32_T i{0}; i < loop_ub; i++) {
      C[i] = 0.0;
    }
    ...
    C.set_size(&x_emlrtRTEI, &b_st, A.size(1));
    dgemm(&TRANSA1, &TRANSB1, &m_t, &n_t, &k_t, &alpha1,
          &(((::coder::array<real_T, 2U> *)&A)->data())[0], &lda_t,
            ...
            const ::coder::array<real_T, 2U> &B, ::coder::array<real_T, 2U> &C)
{
  ...
  if ((A.size(0) == 0) || (A.size(1) == 0) || (B.size(0) == 0) ||
      (B.size(1) == 0)) {
    int32_T loop_ub;
    C.set_size(&y_emlrtRTEI, sp, A.size(0), B.size(1));
    ...
    ldb_t = (ptrdiff_t)B.size(0);
    ldc_t = (ptrdiff_t)A.size(0);
    C.set_size(&x_emlrtRTEI, &b_st, A.size(0), B.size(1));
    dgemm(&TRANSA1, &TRANSB1, &m_t, &n_t, &k_t, &alpha1,
          &(((::coder::array<real_T, 2U> *)&A)->data())[0], &lda_t,
          &(((::coder::array<real_T, 2U> *)&B)->data())[0], &ldb_t, &beta1,
          &(C.data())[0], &ldc_t);
            ...
            const ::coder::array<real_T, 1U> &B, ::coder::array<real_T, 1U> &C)
{
  ...
  if ((A.size(0) == 0) || (A.size(1) == 0) || (B.size(0) == 0)) {
    int32_T loop_ub;
    C.set_size(&y_emlrtRTEI, sp, A.size(0));
    loop_ub = A.size(0);
    for (int32_T i{0}; i < loop_ub; i++) {
      C[i] = 0.0;
    }
    ...
    ldb_t = (ptrdiff_t)B.size(0);
    ldc_t = (ptrdiff_t)A.size(0);
    C.set_size(&x_emlrtRTEI, &b_st, A.size(0));
    dgemm(&TRANSA1, &TRANSB1, &m_t, &n_t, &k_t, &alpha1,
          &(((::coder::array<real_T, 2U> *)&A)->data())[0], &lda_t,
          &(((::coder::array<real_T, 1U> *)&B)->data())[0], &ldb_t, &beta1,
          &(C.data())[0], &ldc_t);
