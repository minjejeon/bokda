  ...
  if (A.size(0) != A.size(1)) {
    ...
    if (Hinv.size(0) != n) {
      ...
      emlrtForLoopVectorCheckR2021a(static_cast<real_T>(n), -1.0, 1.0,
                                    mxDOUBLE_CLASS, i, &f_emlrtRTEI, &st);
      k = 0;
      exitg1 = false;
      while ((!exitg1) && (k <= i - 1)) {
        int32_T b_k;
        ...
        if ((b_k < 1) || (b_k > Hinv.size(1))) {
          emlrtDynamicBoundsCheckR2012b(b_k, 1, Hinv.size(1), &k_emlrtBCI, &st);
        }
        if (b_k > Hinv.size(0)) {
          emlrtDynamicBoundsCheckR2012b(b_k, 1, Hinv.size(0), &k_emlrtBCI, &st);
        }
        ...
        if (sum == 0.0) {
          ...
          if (b_k > Hinv.size(1)) {
            emlrtDynamicBoundsCheckR2012b(b_k, 1, Hinv.size(1), &i_emlrtBCI,
                                          &st);
          }
          if (b_k > Hinv.size(0)) {
          ...
          emlrtForLoopVectorCheckR2021a(static_cast<real_T>(b_k) - 1.0, -1.0,
                                        1.0, mxDOUBLE_CLASS, i1, &e_emlrtRTEI,
                                        &st);
          for (int32_T b_i{0}; b_i < i1; b_i++) {
            ...
            if (c_i > b_k) {
              ...
              if ((c_i < 1) || (c_i > Hinv.size(1))) {
                emlrtDynamicBoundsCheckR2012b(c_i, 1, Hinv.size(1), &p_emlrtBCI,
                                              &st);
              }
              i2 = c_i - 2;
              if (b_k > Hinv.size(1)) {
                emlrtDynamicBoundsCheckR2012b(b_k, 1, Hinv.size(1), &o_emlrtBCI,
                                              &st);
              }
              i3 = b_k - 1;
              if (c_i > Hinv.size(0)) {
                emlrtDynamicBoundsCheckR2012b(c_i, 1, Hinv.size(0), &n_emlrtBCI,
                                              &st);
              }
              i4 = c_i - 2;
              if (b_k > Hinv.size(0)) {
                emlrtDynamicBoundsCheckR2012b(b_k, 1, Hinv.size(0), &m_emlrtBCI,
                                              &st);
              }
              i5 = b_k - 1;
            }
            ...
            if (b_k > Hinv.size(1)) {
              emlrtDynamicBoundsCheckR2012b(b_k, 1, Hinv.size(1), &l_emlrtBCI,
                                            &b_st);
            }
            b_loop_ub = i5 - i4;
            ...
            if (b_k > Hinv.size(1)) {
              emlrtDynamicBoundsCheckR2012b(b_k, 1, Hinv.size(1), &g_emlrtBCI,
                                            &st);
            }
            if ((c_i - 1 < 1) || (c_i - 1 > Hinv.size(0))) {
              emlrtDynamicBoundsCheckR2012b(c_i - 1, 1, Hinv.size(0),
    ...
    if ((Hinv.size(0) == 0) || (Hinv.size(1) == 0)) {
      ...
      Ainv.set_size(&q_emlrtRTEI, &d_st, Hinv.size(0), Hinv.size(0));
    ...
    emlrtSizeEqCheckNDR2012b(&iv2[0], &b_Ainv[0], &i_emlrtECI, (emlrtCTX)sp);
