             ...
             coder::array<real_T, 2U> &R, real_T *err)
{
  ...
  emlrtSizeEqCheckNDR2012b(&iv[0], &b_A[0], &p_emlrtECI, (emlrtCTX)sp);
  L.set_size(&lb_emlrtRTEI, sp, A.size(0), A.size(1));
  last = A.size(1);
  for (i = 0; i < last; i++) {
    idx = A.size(0);
    for (i1 = 0; i1 < idx; i1++) {
  ...
  st.site = &x_emlrtRSI;
  L.set_size(&mb_emlrtRTEI, &st, A.size(0), A.size(1));
  ...
  K.set_size(&nb_emlrtRTEI, &g_st, 1, varargin_1.size(1));
  ...
  d_st.site = &dc_emlrtRSI;
  e_st.site = &ec_emlrtRSI;
  K.set_size(&ob_emlrtRTEI, &e_st, 1, 3);
  K[0] = b_gamma;
  K[1] = theta;
  ...
  //  initialize d and L
  b_d.set_size(&pb_emlrtRTEI, sp, n);
  for (i = 0; i < n; i++) {
    b_d[i] = 0.0;
  }
  st.site = &bb_emlrtRSI;
  ...
  for (j = 0; j < n; j++) {
    real_T djtemp;
    if (j < 1) {
      K.set_size(&qb_emlrtRTEI, sp, 1, 0);
    } else {
      K.set_size(&qb_emlrtRTEI, sp, 1, j);
      last = j - 1;
      for (i = 0; i <= last; i++) {
    ...
    r.set_size(&rb_emlrtRTEI, sp, K.size(1));
    last = K.size(1);
    for (i = 0; i < last; i++) {
      r[i] = K[i];
    }
    ...
    if (j + 1 > L.size(0)) {
      emlrtDynamicBoundsCheckR2012b(j + 1, 1, L.size(0), &x_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    ...
    if (r.size(0) != diagA.size(0)) {
      emlrtSizeEqCheck1DR2012b(r.size(0), diagA.size(0), &n_emlrtECI,
                               (emlrtCTX)sp);
    }
    st.site = &cb_emlrtRSI;
    if (j + 1 > L.size(0)) {
      emlrtDynamicBoundsCheckR2012b(j + 1, 1, L.size(0), &y_emlrtBCI, &st);
    }
    K.set_size(&tb_emlrtRTEI, &st, 1, r.size(0));
    last = r.size(0);
    for (i = 0; i < last; i++) {
      i1 = static_cast<int32_T>(r[i]);
      if (i1 > L.size(1)) {
    ...
    b_varargin_1.set_size(&ub_emlrtRTEI, &st, r.size(0));
    last = r.size(0);
    for (i = 0; i < last; i++) {
    ...
    coder::dynamic_size_checks(&b_st, K, b_varargin_1, r.size(0),
                               b_varargin_1.size(0));
    if (j + 1 > A.size(0)) {
      emlrtDynamicBoundsCheckR2012b(j + 1, 1, A.size(0), &db_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    if (j + 1 > A.size(1)) {
      emlrtDynamicBoundsCheckR2012b(j + 1, 1, A.size(1), &db_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    djtemp =
    ...
    if (j + 1 < n) {
      ...
      if (static_cast<uint32_T>(n) < j + 2U) {
        K.set_size(&vb_emlrtRTEI, &b_st, 1, 0);
      } else {
        i = n - j;
        K.set_size(&vb_emlrtRTEI, &b_st, 1, i - 1);
        last = i - 2;
        for (i = 0; i <= last; i++) {
      ...
      for (i = 0; i < last; i++) {
        i1 = static_cast<int32_T>(r[i]);
        if (i1 > b_d.size(0)) {
          emlrtDynamicBoundsCheckR2012b(i1, 1, b_d.size(0), &eb_emlrtBCI,
                                        (emlrtCTX)sp);
        }
      }
      if (j + 1 > L.size(0)) {
        emlrtDynamicBoundsCheckR2012b(j + 1, 1, L.size(0), &v_emlrtBCI,
                                      (emlrtCTX)sp);
      }
      ...
      for (i = 0; i < last; i++) {
        ...
        if (i1 > L.size(1)) {
          emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(r[i]), 1,
                                        L.size(1), &gb_emlrtBCI, (emlrtCTX)sp);
        }
        diagA[i] = L[j + L.size(0) * (i1 - 1)];
      }
      if (r.size(0) != diagA.size(0)) {
      ...
      r1.set_size(&xb_emlrtRTEI, sp, K.size(1));
      last = K.size(1);
      for (i = 0; i < last; i++) {
        r1[i] = K[i];
      }
      ...
      for (i = 0; i < last; i++) {
        ...
        if (r1[i] != i1) {
          emlrtIntegerCheckR2012b(r1[i], &e_emlrtDCI, (emlrtCTX)sp);
        }
        if ((i1 < 1) || (i1 > A.size(0))) {
          emlrtDynamicBoundsCheckR2012b(i1, 1, A.size(0), &hb_emlrtBCI,
                                        (emlrtCTX)sp);
        }
      }
      if (j + 1 > A.size(1)) {
      ...
      st.site = &eb_emlrtRSI;
      varargin_1.set_size(&yb_emlrtRTEI, &st, r1.size(0), r.size(0));
      last = r.size(0);
      for (i = 0; i < last; i++) {
        idx = r1.size(0);
        for (i1 = 0; i1 < idx; i1++) {
          ...
          if (k > L.size(1)) {
            emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(r[i]), 1,
                                          L.size(1), &jb_emlrtBCI, &st);
          }
          varargin_1[i1 + varargin_1.size(0) * i] =
              L[(a + L.size(0) * (k - 1)) - 1];
        }
      }
      b_varargin_1.set_size(&ac_emlrtRTEI, &st, r.size(0));
      last = r.size(0);
      for (i = 0; i < last; i++) {
        b_varargin_1[i] = b_d[static_cast<int32_T>(r[i]) - 1] * diagA[i];
      }
      ...
      if (r1.size(0) != r.size(0)) {
        emlrtSizeEqCheck1DR2012b(r1.size(0), r.size(0), &l_emlrtECI,
                                 (emlrtCTX)sp);
      }
      diagA.set_size(&bc_emlrtRTEI, sp, r1.size(0));
      last = r1.size(0);
      for (i = 0; i < last; i++) {
      ...
      r2.set_size(&cc_emlrtRTEI, sp, r1.size(0));
      last = r1.size(0);
      for (i = 0; i < last; i++) {
        i1 = static_cast<int32_T>(r1[i]);
        if ((i1 < 1) || (i1 > L.size(0))) {
          emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(r1[i]), 1,
                                        L.size(0), &lb_emlrtBCI, (emlrtCTX)sp);
        }
        r2[i] = i1 - 1;
      }
      if (j + 1 > L.size(1)) {
        emlrtDynamicBoundsCheckR2012b(j + 1, 1, L.size(1), &u_emlrtBCI,
                                      (emlrtCTX)sp);
      }
      if (j + 1 > b_d.size(0)) {
      ...
      emlrtSubAssignSizeCheckR2012b(r2.size(), 1, diagA.size(), 1, &k_emlrtECI,
                                    (emlrtCTX)sp);
      last = diagA.size(0);
      for (i = 0; i < last; i++) {
    ...
    if (j + 1 > b_d.size(0)) {
      emlrtDynamicBoundsCheckR2012b(j + 1, 1, b_d.size(0), &t_emlrtBCI,
                                    (emlrtCTX)sp);
    }
  ...
  for (j = 0; j < n; j++) {
    if (j + 1 > L.size(1)) {
      emlrtDynamicBoundsCheckR2012b(j + 1, 1, L.size(1), &r_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    st.site = &ib_emlrtRSI;
    if (j + 1 > b_d.size(0)) {
      emlrtDynamicBoundsCheckR2012b(j + 1, 1, b_d.size(0), &s_emlrtBCI, &st);
    }
    theta = muDoubleScalarSqrt(b_d[j]);
    last = L.size(0);
    r.set_size(&dc_emlrtRTEI, sp, L.size(0));
    for (i = 0; i < last; i++) {
      r[i] = L[i + L.size(0) * j] * theta;
    }
    emlrtSubAssignSizeCheckR2012b(L.size(), 1, r.size(), 1, &j_emlrtECI,
                                  (emlrtCTX)sp);
    last = r.size(0);
    for (i = 0; i < last; i++) {
      L[i + L.size(0) * j] = r[i];
  ...
  R.set_size(&ec_emlrtRTEI, sp, L.size(1), L.size(0));
  last = L.size(0);
  for (i = 0; i < last; i++) {
    idx = L.size(1);
    for (i1 = 0; i1 < idx; i1++) {
