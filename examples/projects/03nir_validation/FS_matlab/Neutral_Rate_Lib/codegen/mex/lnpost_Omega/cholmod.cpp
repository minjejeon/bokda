             ...
             coder::array<real_T, 2U> &R, real_T *err)
{
  ...
  for (j = 0; j < n; j++) {
    ...
    if (j + 1 > L.size(0)) {
      emlrtDynamicBoundsCheckR2012b(j + 1, 1, L.size(0), &s_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    ...
    st.site = &v_emlrtRSI;
    if (j + 1 > L.size(0)) {
      emlrtDynamicBoundsCheckR2012b(j + 1, 1, L.size(0), &t_emlrtBCI, &st);
    }
    ...
    if (j + 1 < n) {
      ...
      if (j + 1 > L.size(0)) {
        emlrtDynamicBoundsCheckR2012b(j + 1, 1, L.size(0), &q_emlrtBCI,
                                      (emlrtCTX)sp);
      }
      ...
      if (j + 1 > A.size(1)) {
        emlrtDynamicBoundsCheckR2012b(j + 1, 1, A.size(1), &r_emlrtBCI,
                                      (emlrtCTX)sp);
      }
      st.site = &x_emlrtRSI;
      ...
      if (j + 1 > L.size(1)) {
        emlrtDynamicBoundsCheckR2012b(j + 1, 1, L.size(1), &p_emlrtBCI,
                                      (emlrtCTX)sp);
      }
      if (j + 1 > b_d.size(0)) {
    ...
    if (j + 1 > b_d.size(0)) {
      emlrtDynamicBoundsCheckR2012b(j + 1, 1, b_d.size(0), &o_emlrtBCI,
                                    (emlrtCTX)sp);
    }
